...
class ArchivesControllerTest < ActionController::TestCase
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post :create, archive: { archive_id: @archive.archive_id, order_id: @archive.order_id, products_id: @archive.products_id }
    end
  ...
  test "should update archive" do
    patch :update, id: @archive, archive: { archive_id: @archive.archive_id, order_id: @archive.order_id, products_id: @archive.products_id }
    assert_redirected_to archive_path(assigns(:archive))
  end
